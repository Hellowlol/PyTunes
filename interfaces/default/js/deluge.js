        ...
        success: function (response) {
            if (response && response.result) {
                ...
                for (var key in response.result) {
                    ...
                    tr.append(
                    $('<td>').html(torrent.name + '<br><small><i class="icon-long-arrow-down"></i> ' + getReadableFileSizeString(torrent.download_payload_rate) + '/s <i class="icon-long-arrow-up"></i> ' + getReadableFileSizeString(torrent.upload_payload_rate) + '/s</small>'),
