...
class NzbDrone:
    def __init__(self):
        ...
        pytunes.MODULES.append({
            'name': 'NzbDrone',
            'id': 'nzbdrone',
            'test': pytunes.WEBDIR + 'nzbdrone/Version',
            'fields': [
    ...
    @cherrypy.expose()
    def index(self):
        return pytunes.LOOKUP.get_template('nzbdrone.html').render(scriptname='nzbdrone')

    def fetch(self, path, banner=None, type=None, data=None):
        try:
            host = pytunes.settings.get('nzbdrone_host', '')
            port = str(pytunes.settings.get('nzbdrone_port', ''))
            nzbdrone_basepath = pytunes.settings.get('nzbdrone_basepath', '/')
            ssl = 's' if pytunes.settings.get('nzbdrone_ssl', True) else ''
            ...
            headers = {'X-Api-Key': pytunes.settings.get('nzbdrone_apikey', '')}
    ...
    def View(self, tvdbid, id):
        ...
        return pytunes.LOOKUP.get_template('nzbdrone_view.html').render(scriptname='nzbdrone_view', tvdbid=tvdbid, id=id)
